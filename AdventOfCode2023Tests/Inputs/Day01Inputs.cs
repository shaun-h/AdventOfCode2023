...
public class Day01Inputs
{
    public static string Example01 = @"1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet";
    
    public static string Example02 = @"two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
7pqrstsixteen";
    ...
    public static string Real = @"tsgbzmgbonethreedrqzbhxjkvcnm3
